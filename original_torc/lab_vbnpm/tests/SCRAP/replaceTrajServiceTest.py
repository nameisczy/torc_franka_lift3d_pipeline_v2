...
plan0 = planner.joint_motion_plan(joint_state, start, 'arms')
input("Execute?")
execute(plan0)
...
plan1 = None
t1 = None
while t1 is None or tft.to_sec() < 0.2 * WINDOW + (t1 - t):
...
if plan1:
    ...
    print('Failed to get planning point!')
