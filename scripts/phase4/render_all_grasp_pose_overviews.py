...
OUT_DIR = artifact_path("all_grasp_pose_overviews")
OUT_COMBINED = result_path("franka_all_grasp_pose_overviews.png")
OUT_MANIFEST = artifact_path("all_grasp_pose_overviews_manifest.json")
